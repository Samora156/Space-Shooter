package com.example.spaceshooterv100;
...
import static com.example.spaceshooterv100.GameView.METEOR_DESTROYED;
import static com.example.spaceshooterv100.GameView.SCORE;
...
public class Meteor {
    ...
    public Meteor(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer){
        ...
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.meteor_3);
